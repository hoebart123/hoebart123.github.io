...
<body>
    ...
    <?php
        if(isset($_SESSION['user_id']))
        {
            ...
            $query = "SELECT * FROM logs WHERE user = :user ORDER BY date DESC LIMIT 3";
            ...
            if ($logs) {
                ...
                echo "<p>Geen logs gevonden.</p>";
            }
        }
        else
        {
            echo "<p><a href='login.php' class='btn'>Login om te bekijken</a></p>";
        }
    ?>
</div>
    </div>
